...
const resultsRadioButtons = (props) => {
    return (
        <View style={{ flexDirection: 'row', flex: 1, justifyContent: 'space-between' }}>
            ...
            <View style={{ flexDirection: 'row' }}>
                ...
                <Text style={{ color: '#FFFFFF' }}>{LocalizedStrings[props.language].normal}</Text>
                ...
                <Text style={{ color: '#FFFFFF' }}>{LocalizedStrings[props.language].abnormal}</Text>
            </View>
        </View>
    )
}

export default resultsRadioButtons