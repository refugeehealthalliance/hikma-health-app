      ...
      <View style={[styles.main, { justifyContent: 'space-between' }]}>
        ...
        <View style={{ alignItems: 'stretch', flex: 1 }}>
          ...
          <TouchableOpacity
            ...
            <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-between' }}>
              <Text style={styles.gridItemText}>{LocalizedStrings[language].vitals}</Text>
              <Text style={styles.gridItemText}>></Text>
            </View>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.profileButton}
            onPress={() => props.navigation.navigate('SnapshotList', { eventType: EventTypes.Lab, language: language, patient: patient })}>
            <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-between' }}>
              <Text style={styles.gridItemText}>{LocalizedStrings[language].bloodTestImaging}</Text>
              <Text style={styles.gridItemText}>></Text>
            </View>
          </TouchableOpacity>
          {/* <TouchableOpacity
          ...
          <TouchableOpacity
            style={styles.profileButton}
            onPress={() => props.navigation.navigate('SnapshotList', { eventType: EventTypes.Physiotherapy, language: language, patient: patient })}>
            <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-between' }}>
              <Text style={styles.gridItemText}>{LocalizedStrings[language].physiotherapy}</Text>
              <Text style={styles.gridItemText}>></Text>
            </View>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.profileButton}
            onPress={() => props.navigation.navigate('SnapshotList', { eventType: EventTypes.CommonProblems, language: language, patient: patient })}>
            <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-between' }}>
              <Text style={styles.gridItemText}>{LocalizedStrings[language].commonProblems}</Text>
              <Text style={styles.gridItemText}>></Text>
            </View>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.profileButton}
            onPress={() => props.navigation.navigate('SnapshotList', { eventType: EventTypes.Interventions, language: language, patient: patient })}>
            <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-between' }}>
              <Text style={styles.gridItemText}>{LocalizedStrings[language].interventions}</Text>
              <Text style={styles.gridItemText}>></Text>
            </View>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.profileButton}
            onPress={() => props.navigation.navigate('SnapshotList', { eventType: EventTypes.MentalHealth, language: language, patient: patient })}>
            <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-between' }}>
              <Text style={styles.gridItemText}>{LocalizedStrings[language].mentalHealthFollowUp}</Text>
              <Text style={styles.gridItemText}>></Text>
            </View>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.profileButton}
            onPress={() => props.navigation.navigate('SnapshotList', { eventType: EventTypes.DentalTreatment, language: language, patient: patient })}>
            <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-between' }}>
              <Text style={styles.gridItemText}>{LocalizedStrings[language].dentalTreatment}</Text>
              <Text style={styles.gridItemText}>></Text>
            </View>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.profileButton}
            onPress={() => props.navigation.navigate('SnapshotList', { eventType: EventTypes.NursingNotes, language: language, patient: patient })}>
            <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-between' }}>
              <Text style={styles.gridItemText}>{LocalizedStrings[language].nursingNotes}</Text>
              <Text style={styles.gridItemText}>></Text>
            </View>
          </TouchableOpacity>
        </View>
